...
class RecordApiHelper
{
  ...
  public function executeRecordApi($formID, $entryID, $module, $fieldValues, $fieldMap, $uploadFieldMap, $required)
  {
    ...
    if ('customer' === $module) {
      ...
      do_action('woocommerce_update_customer',  $user_id); // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedHooknameFound -- WooCommerce core hook.
    }
