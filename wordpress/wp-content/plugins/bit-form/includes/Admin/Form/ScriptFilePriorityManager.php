  ...
  public static function jsFile()
  {
    ...
    return [
      ...
      'paypal' => [
        ...
        ['priority' => 303, 'filename' => 'initPaypalFld.min.js'],
      ],
      'stripe' => [
        ...
        ['priority' => 302, 'filename' => 'scriptLoader.min.js'],
        ['priority' => 303, 'filename' => 'initStripeFld.min.js'],
      ],
      'mollie' => [
        ['priority' => 201, 'filename' => 'bitsFetchFront.min.js'],
        ['priority' => 201, 'filename' => 'isFormValidatedWithoutError.min.js'],
      ...
      'razorpay' => [
        ...
        ['priority' => 302, 'filename' => 'scriptLoader.min.js'],
        ['priority' => 303, 'filename' => 'initRazorpayFld.min.js'],
      ],
      'radio' => [
        ['priority' => 301, 'filename' => 'initAddOtherOpt.min.js', 'path' => 'addOtherOpt'],
        ['priority' => 301, 'filename' => 'resetOtherOpt.min.js', 'path' => 'addOtherOpt'],
      ],
      'check' => [
        ['priority' => 301, 'filename' => 'initAddOtherOpt.min.js', 'path' => 'addOtherOpt'],
        ['priority' => 301, 'filename' => 'resetOtherOpt.min.js', 'path' => 'addOtherOpt'],
        ['priority' => 302, 'filename' => 'initCheckDisableOnMax.min.js', 'path' => 'valid->disableOnMax'],
      ],
      'image-select' => [
        ['priority' => 302, 'filename' => 'initCheckDisableOnMax.min.js', 'path' => 'valid->disableOnMax'],
      ],
