...
<div class="wpte-field">
	<div class="wpte-info-block">
		<?php printf( 'This section includes all the display settings for Trip Card/Listing page. Click <a href="%s" target="_blank">here</a> to see the page.', esc_url( $trip_page_url ), 'wp-travel-engine' ); ?>
	</div>
</div>
...
<div class="wpte-field-subfields<?php echo $new_trip_card ? '' : ' hidden'; ?>" data-display-new-trip-listing>
	...
	<div class="wpte-field wpte-floated">
		<div class="wpte-field wpte-checkbox advance-checkbox">
			...
			<span class="wpte-tooltip"><?php printf( 'Click <a href="%s">here</a> to add difficulty level.', esc_url( $difficulty_tax_url ), 'wp-travel-engine' ); ?></span>
		</div>
	</div>
	<div class="wpte-field wpte-floated">
		<div class="wpte-field wpte-checkbox advance-checkbox">
			...
			<span class="wpte-tooltip"><?php printf( 'Click <a href="%s">here</a> to add a tag.', esc_url( $tag_tax_url ), 'wp-travel-engine' ); ?></span>
		</div>
	</div>
	<div class="wpte-field wpte-floated">
		<div class="wpte-field wpte-checkbox advance-checkbox">
